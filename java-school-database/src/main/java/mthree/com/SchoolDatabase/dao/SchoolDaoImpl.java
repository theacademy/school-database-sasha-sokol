    ...
    * Do not change any code outside of the placeholders provided.
    ...
    public List<Course> csCourses() {
        ...
        // YOUR CODE STARTS HERE
         ...
         String sql = """
                    SELECT courseCode, courseDesc FROM course 
                        JOIN teacher ON teacherId = tid 
    ...
    public List<StudentClassCount> studentsPerClass() {
        ...
        String sql = """
                SELECT courseCode, courseDesc, COUNT(*) AS numStudents
                FROM course_student
    ...
    public void addStudentToClass() {
        ...
        String sql = """
                INSERT INTO course_student VALUES (123,
